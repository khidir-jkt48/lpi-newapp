...
// Komponen Card untuk menampilkan menu dengan dropdown
const MenuCard = ({ menu }) => {
...
const demoData = [
  {
    id: 1,
    nama: 'QLA Monitoring System',
    link: 'https://script.google.com/a/macros/abata.sch.id/s/AKfycbwDB6v2DsGrO0nEEwxyBPSUCRgIF2sr1VNVLbB3Wsgl6VrHAkqyH4qZfNAypfirRHor9g/exec',
    banner: 'https://imgur.com/gvv6T20.png',
    icon: ''
  },
  {
    id: 2,
    nama: 'Lunch Management',
    link: 'https://script.google.com/a/macros/abata.sch.id/s/AKfycbztcbsItJKdgnxihqZKVgdYd_F-wdMhqucro8Nw_kcDRcthmlz70b90zGknvdOJzkPW/exec',
    banner: 'https://i.imgur.com/SiZi6hm.png',
    icon: ''
  },
  {
    id: 3,
    nama: 'PMB Monitoring System',
    link: 'https://script.google.com/a/macros/abata.sch.id/s/AKfycbzbwMrImXypExAnKH8jOri-MOOfO4QIWkwOOqnXHjrXXoEw-Gm7XJohBtYR7TkY21C-/exec',
    banner: 'https://i.imgur.com/SiZi6hm.png',
    icon: ''
  },
];
    ...
    <div className="app-container">
      ...
      <div className="header">
        <img 
          ...
          alt="LPI Abata Logo"
          onError={(e) => {
            e.target.src = 'data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTAwIiBoZWlnaHQ9IjEwMCIgdmlld0JveD0iMCAwIDEwMCAxMDAiIGZpbGw9Im5vbmUiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+CjxyZWN0IHdpZHRoPSIxMDAiIGhlaWdodD0iMTAwIiByeD0iNTAiIGZpbGw9IiMzMzMiLz4KPC9zdmc+';
          }}
        />
